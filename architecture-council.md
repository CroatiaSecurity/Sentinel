...
**Status:** Historical architecture rationale. **Runtime inventory and versions are authoritative in `design.md` (v1.7.9).** This document explains the President/Council mental model; do not treat monitor tables here as the live registration list.

**Last updated note:** v1.7.9 — Header aligned; live component inventory lives only in `design.md`.
