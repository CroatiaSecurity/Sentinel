...
Download **`SentinelSetup-2.0.2.exe`** from [GitHub Releases](https://github.com/CroatiaSecurity/Sentinel/releases) (or `releases/2.0.2/` after a local build) and run it as Administrator.
