...
namespace Behavedr.Core
{
    ...
    public sealed class ScriptExecutionMonitor : BackgroundService
    {
        ...
        private static readonly string[] MaliciousPatterns = new[]
        {
            ...
            // Behavedr evasion
            "Behavedr", "Behavedr", "Stop-Service.*Behavedr",
            // Download cradles
            ...
            try
            {
                ...
                while ((record = reader.ReadEvent()) != null)
                {
                    using (record)
                    {
                        ...
                        // Tier1 kill for AMSI bypass, credential theft, or Behavedr targeting
                        bool isCritical = matchedPatterns.Any(p =>
                            ...
                            p.Contains("Behavedr", StringComparison.OrdinalIgnoreCase));
