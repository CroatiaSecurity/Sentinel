    ...
    public class JsonlEventLogger : IAsyncDisposable
    {
        ...
        public JsonlEventLogger(string? customPath = null)
        {
            ...
            else
            {
                ...
                _logFilePath = Path.Combine(programData, "Behavedr", "events.jsonl");
            }
            ...
            if (directory != null)
            {
                try
                {
                    ...
                    var prodDir = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData), "Behavedr");
