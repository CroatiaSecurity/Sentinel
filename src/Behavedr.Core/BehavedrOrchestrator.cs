...
{
    /// <summary>
    /// Central coordination point for the entire Behavedr EDR pipeline.
    ///
    /// BehavedrOrchestrator is the "brain" that ties all components together:
    ...
    /// </summary>
    public sealed class BehavedrOrchestrator : IDisposable
    {
        ...
        private readonly ILogger<BehavedrOrchestrator> _logger;
        ...
        public BehavedrOrchestrator(
            ...
            ILogger<BehavedrOrchestrator> logger)
        {
        ...
        /// <summary>
        /// Starts the entire Behavedr system in dependency order.
        /// Called by BehavedrService.ExecuteAsync instead of the old foreach loop.
        /// </summary>
        public async Task<StartupReport> StartSystemAsync(CancellationToken ct)
        {
            _startTime = DateTimeOffset.UtcNow;
            _logger.LogInformation("[Orchestrator] Starting Behavedr system...");
        ...
        {
            _isRunning = false;
            _logger.LogInformation("[Orchestrator] Shutting down Behavedr system...");
        ...
        /// <summary>
        /// Returns the unified health status of the entire Behavedr system.
