    ...
    public class FileVerdictAds
    {
        ...
        private static byte[] Protect(byte[] data)
        {
            ...
            try
            {
                ...
                if (CryptProtectData(ref dataIn, "BehavedrAdsKey", ref entropy, IntPtr.Zero, ref prompt, CRYPTPROTECT_UI_FORBIDDEN, ref dataOut))
                {
        ...
        {
            var adsPath = $"{filePath}:behavedr_verdict";
            try
            {
