        ...
        private void SetMute(bool mute)
        {
            try
            {
                ...
                if (mute)
                {
                    ...
                    // EXCEPT known-safe processes (Harmony, system sounds, Behavedr itself)
