...
# REMOVED: Restarting explorer.exe is highly disruptive to the user (closes folder windows, flashes desktop)
# and can cause tray icons for background services (like Sentinel Agent) to disappear.
# Instead, the tray promotion settings will apply automatically on the next login due to the registered logon task.
