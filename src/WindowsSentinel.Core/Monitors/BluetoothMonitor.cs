...
/// <summary>
/// Bluetooth Attack Surface Monitor (v3.6.0) — Detects Bluetooth-based attacks.
///
/// Bluetooth is an often-overlooked attack vector. Attacks include:
///   - BlueBorne (CVE-2017-8628) — remote code execution via BT
...
///   3. Alert on HID-class BT devices pairing (keyboard/mouse — BadBT attacks).
...
public sealed class BluetoothMonitor : BackgroundService
{
    ...
    // HID device class GUIDs (keyboards, mice — BadBT attack vectors)
    ...
    {
        _logger.LogInformation("[BluetoothMonitor] Starting — Bluetooth attack surface monitoring active");
