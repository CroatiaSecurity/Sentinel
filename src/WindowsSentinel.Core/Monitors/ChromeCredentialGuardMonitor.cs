...
/// <summary>
/// Chrome Credential Guard Monitor — Detects unauthorized access to Chrome/Chromium
...
public sealed class ChromeCredentialGuardMonitor : BackgroundService
{
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // SENSITIVE BROWSER FILES — These contain credentials, cookies, or keys
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // BROWSER PROFILE PATHS — All Chromium-based browsers
    // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ═══════════════════════════════════════════════════════════════════════════
    // LEGITIMATE PROCESSES — Allowed to access browser data
    // ═══════════════════════════════════════════════════════════════════════════
                ...
                if (processAge < TimeSpan.FromMinutes(2))
                {
                    ...
                    if (ShouldAlert(alertKey))
                    {
                        ...
                        await EmitDetectionAsync(
                            ...
                            "infostealer malware. These tools typically: spawn → copy Login Data/Cookies → " +
                            "decrypt with DPAPI key from Local State → exfiltrate → exit. The entire " +
