...
/// <summary>
/// Windows Update Integrity Monitor (v3.6.0) â€” Detects update service tampering.
///
...
///
/// Also monitors Windows Defender update state â€” if definitions are stale,
...
public sealed class WindowsUpdateIntegrityMonitor : BackgroundService
{
    ...
    {
        _logger.LogInformation("[WindowsUpdateIntegrityMonitor] Starting â€” update integrity monitoring active");
