...
/// <summary>
/// DLL Entropy Analyzer â€” Detects packed, encrypted, or obfuscated DLLs by measuring
            ...
            try
            {
                ...
                foreach (var filePath in files)
                {
                    ...
                    try
                    {
                        ...
                        if (fileInfo.LastWriteTimeUtc < cutoff.ToUniversalTime()) continue;
