...
/// <summary>
/// Gateway Fingerprint Monitor (v3.6.0) â€” Detects rogue access points and evil twins.
///
...
public sealed class GatewayFingerprintMonitor : BackgroundService
{
    ...
    {
        _logger.LogInformation("[GatewayFingerprintMonitor] Starting â€” network fingerprint monitoring active");
        ...
        {
            _logger.LogWarning("[GatewayFingerprintMonitor] Could not capture baseline â€” no active network");
        }
