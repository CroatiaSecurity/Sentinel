...
/// <summary>
/// IoC scanner â€” matches files / IPs / domains against a curated list.
///
...
public sealed class IoCScanner
{
    ...
    private DateTimeOffset _lastReload = DateTime.MinValue;
    ...
    /// <summary>
    /// Periodic maintenance â€” currently a no-op placeholder for live feed reload.
    /// Reload is gated to once per 5 minutes.
    /// </summary>
    public void Maintenance()
    {
        if (DateTime.UtcNow - _lastReload < TimeSpan.FromMinutes(5)) return;
        Save();
