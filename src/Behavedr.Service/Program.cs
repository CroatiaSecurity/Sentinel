...
namespace Behavedr.Service
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            // Secure Behavedr's installation directory permissions
        ...
        public static IHostBuilder CreateHostBuilder(string[] args) =>
            Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    hostContext.Configuration.GetSection("Behavedr").Bind(config);
                    ...
                    services.AddSingleton<BehavedrMetrics>();
                    ...
                    services.AddSingleton<BehavedrOrchestrator>();

                    // IMonitor implementations (started by BehavedrService)
                    ...
                    // Monitors injected into BehavedrService (singleton for cross-service access)
                    ...
                    services.AddHostedService<BehavedrHealthCheck>();

                    // Core BehavedrService (manages IMonitor lifecycle + ProcessAncestryCache)
                    services.AddHostedService<BehavedrService>();
                    ...
                    // Behavedr itself and must never stay down.
