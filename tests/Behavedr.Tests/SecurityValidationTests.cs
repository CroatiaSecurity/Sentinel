...
namespace Behavedr.Tests
{
    public class SecurityValidationTests
    {
        ...
        [Theory]
        [InlineData(@"C:\ProgramData\Behavedr\Quarantine\file.quarantined", @"C:\ProgramData\Behavedr\Quarantine")]
        [InlineData(@"C:\ProgramData\Behavedr\Quarantine\sub\file.quarantined", @"C:\ProgramData\Behavedr\Quarantine")]
        ...
        [Theory]
        [InlineData(@"C:\ProgramData\Behavedr\Quarantine\..\..\..\Windows\System32\config\sam", @"C:\ProgramData\Behavedr\Quarantine")]
        [InlineData(@"C:\Windows\System32\cmd.exe", @"C:\ProgramData\Behavedr\Quarantine")]
        [InlineData(@"D:\other\path\file.exe", @"C:\ProgramData\Behavedr\Quarantine")]
